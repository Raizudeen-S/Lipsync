...
def main_upscale(
    input_path="inputs/wav2lip_out/output.mp4",
    ...
    # Disable frame extraction for non-videos
    ...
    # Clean up temporary frames if needed
    if extract_frame_first:
        tmp_frames_folder = osp.join(output, f"{osp.basename(input_path)}_inp_tmp_frames")

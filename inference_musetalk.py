...
@torch.no_grad()
def inference(video_path, audio_path, bbox_shift=0, result_dir="./inputs/wav2lip_out", fps=25, batch_size=8, output_vid_name=None, use_saved_coord=True, use_float16=False):
    global pe
    if use_float16:
        pe = pe.half()
